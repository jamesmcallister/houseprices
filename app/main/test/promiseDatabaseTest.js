...
describe('Promise Databse', () => {
    ...
    it("Calls the influx createDatabase when no database present", () => {
        ...
        return promiseDatabaseBuilder(fakeInfluxClient)(promiseDatabaseNames)(testDatabaseName).then(promisedDatabase => {
    ...
    it("Calls the influx createDatabase when no database present", () => {
        ...
        const promiseDatabaseNames = sinon.stub().returns(Promise.resolve([testDatabaseName]))
        return promiseDatabaseBuilder(fakeInfluxClient)(promiseDatabaseNames)(testDatabaseName).then(promisedDatabase => {
