...
export const promiseDatabaseBuilder = influxClient => promiseDatabaseNames => databaseName => promiseDatabaseNames(databaseName)
    .then(names => {
...
export default () => {
    ...
    return promiseDatabaseBuilder(influxClient)(promiseDatabaseNames)(config.databaseName);
}